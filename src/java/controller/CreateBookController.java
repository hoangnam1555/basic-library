    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (author.isEmpty() || author.length() < 2 || author.length() > 20) {
                    errorDTO.setErrorBookAuthor("20 > Author Name > 2 !");
                    check = false;
                }
                if (status.isEmpty()) {
                ...
                if (dao.checkID(bookID)) {
                    errorDTO.setErrorBookID("Book ID da ton tai");
                    check = false;
                }

                if (check == true) {
                    BookDTO dto = new BookDTO(bookID, title, Integer.parseInt(price.trim()), Integer.parseInt(quantity.trim()),
                ...
                log("error at create book Controller" + e.toString());
            } finally {
